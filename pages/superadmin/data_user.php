...
<head>
    ...
    <title>Data User | E-Arsip - QM Pertamina RU III</title>
                ...
                <div class="container-fluid">
                    <div class="row page-title">
                        <div class="col-md-6 col-8 align-self-center">
                            <h4 class="page-title font-weight-bold">Data User</h4>
                        </div>
                        <div class="col-md-6 col-4 align-self-center">
                            <a href="#" class="btn btn-sm pull-right btn-primary"><i class="la la-plus font-weight-bold"></i> &nbsp;Tambah User</a>
                        </div>
                    </div>
                    &nbsp;
                    <div class="row">
                ...
                <ul class="nav">
                    ...
                    <li class="nav-item collapse">
                        ...
                        <div class="collapse in" id="collapseDokumen" aria-expanded="true">
                            ...
                            <a href="data_user.php" class="active bg-active">
                                &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                                <span class="la la-caret-right"></span>
                                &nbsp;
                                <span>User</span>
