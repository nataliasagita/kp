...
<head>
    ...
    <title>Data Admin | E-Arsip - QM Pertamina RU III</title>
                ...
                <div class="container-fluid">
                    <div class="row page-title">
                        <div class="col-md-6 col-8 align-self-center">
                            <h4 class="page-title font-weight-bold">Data Admin</h4>
                        </div>
                        <div class="col-md-6 col-4 align-self-center">
                            <a href="#" class="btn btn-sm pull-right btn-primary"><i class="la la-plus font-weight-bold"></i> &nbsp;Tambah Admin</a>
                        </div>
                    </div>
                    &nbsp;
                    <div class="row">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table class="table table-striped table-bordered table-hover" id="tabelAdmin">
                ...
                <ul class="nav">
                    ...
                    <li class="nav-item collapse">
                        ...
                        <div class="collapse in" id="collapseDokumen" aria-expanded="true">
                            ...
                            <a href="data_admin.php" class="active bg-active">
                                &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                                <span class="la la-caret-right"></span>
                                &nbsp;
                                <span>Admin</span>
