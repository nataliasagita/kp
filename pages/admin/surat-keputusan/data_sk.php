                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-striped table-bordered table-hover" id="tabelDokumen">
                                            ...
                                            <tbody>
                                                <?php
                                                $no = 1;
                                                $hasil = mysqli_query($koneksi, "SELECT*FROM tb_sk");
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <a href="edit.php?id_sk=<?= $data["id_sk"]; ?>" class="btn btn-warning p-1 mr-1 mb-1">
                                                                <i class="la la-edit"></i>
                                                            </a>
                                                            <a href="delete.php?id_sk=<?= $data["id_sk"]; ?>" class="btn btn-danger p-1 mr-1 mb-1 delete" onclick="alertHapus()">
