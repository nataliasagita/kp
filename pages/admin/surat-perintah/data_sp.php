...
<head>
    ...
    <title>Surat Perintah | E-Arsip - QM Pertamina RU III</title>
                ...
                <div class="container-fluid">
                    <div class="row page-title">
                        <div class="col-md-6 col-8 align-self-center">
                            <h4 class="page-title font-weight-bold">Data Surat Perintah</h4>
                        </div>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-striped table-bordered table-hover" id="tabelDokumen">
                                            ...
                                            <tbody>
                                                <?php
                                                $no = 1;
                                                $hasil = mysqli_query($koneksi, "SELECT*FROM tb_sp");
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td><?= $data['berakhir']; ?></td>
                                                        <td>
                                                            <a href="download_pdf.php?id_sp=<?= $data["id_sp"]; ?>" class="btn btn-success p-1 mr-1 mb-1" target="_blank">
                                                                <i class="la la-download"></i>
                                                            </a>
                                                            <a href="edit.php?id_sp=<?= $data["id_sp"]; ?>" class="btn btn-warning p-1 mr-1 mb-1">
                                                                <i class="la la-edit"></i>
                                                            </a>
                                                            <a href="delete.php?id_sp=<?= $data["id_sp"]; ?>" class="btn btn-danger p-1 mr-1 mb-1 delete" onclick="alertHapus()">
