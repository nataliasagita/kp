...
$query = "INSERT INTO tb_sp SET id_sp='', no_surat='$no_surat', tentang='$tentang', user='$user', tmt_berlaku='$tmt_berlaku', berakhir='$berakhir', file_pdf='$file_pdf'";
...
if ($hasil) {
    ...
    setTimeout(() => { 
        ...
        window.setTimeout(() => { 
         window.location.replace('data_sp.php');
        } ,5000); 
    </script>";
} else {
    "<script>
