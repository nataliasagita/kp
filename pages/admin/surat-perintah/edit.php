...
<head>
    ...
    <title>Edit Surat Perintah | E-Arsip - QM Pertamina RU III</title>
                ...
                <ul class="nav">
                    ...
                    <li class="nav-item collapse">
                        ...
                        <div class="collapse in" id="collapseDokumen" aria-expanded="true">
                            ...
                            <a href="../surat-perintah/data_sp.php" class="active bg-active">
                                &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                                <span class="la la-caret-right"></span>
                                &nbsp;
                ...
                <div class="container-fluid">
                    <div class="row page-title">
                        <div class="col-md-6 col-8 align-self-center">
                            <h4 class="page-title font-weight-bold">Edit Surat Perintah</h4>
                        </div>
                    </div>
                    &nbsp;
                    <div class="row">
                                ...
                                <div class="card-body">
                                    <form action="" method="POST">
                                        ...
                                        <div class="form-group form-inline">
                                            ...
                                            <div class="col-md-10 p-0">
                                                <input type="text" class="form-control input-full" id="tmt_berlaku" name="tmt_berlaku" required>
                                            </div>
                                        </div>
                                        <div class="form-group form-inline">
                                            <label for="berakhir" class="col-md-2 col-form-label">Berakhir</label>
                                            <div class="col-md-10 p-0">
                                                <input type="text" class="form-control input-full" id="berakhir" name="berakhir">
                                            </div>
                                        </div>
                                        <div class="form-group form-inline">
