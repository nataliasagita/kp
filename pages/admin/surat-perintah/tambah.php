...
<head>
    ...
    <title>Tambah Surat Perintah | E-Arsip - QM Pertamina RU III</title>
                ...
                <div class="container-fluid">
                    <div class="row page-title">
                        <div class="col-md-6 col-8 align-self-center">
                            <h4 class="page-title font-weight-bold">Tambah Surat Perintah</h4>
                        </div>
                    </div>
                    &nbsp;
                    <div class="row">
                                    ...
                                    <form action="proses_tambah.php" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group row float-right">
                                            <div class="col-sm-5 mb-2 mr-2">
                                                <a href="data_sp.php" class="btn btn-danger p-2 float-right">Batal</a>
                                            </div>
