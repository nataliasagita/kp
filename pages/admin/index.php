...
<head>
    ...
    <title>E-Arsip | QM Pertamina RU III</title>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-7 d-flex align-items-center">
                                            <div class="numbers">
                                                ...
                                                <h4 class="card-title font-weight-bold">1,294</h4>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-7 d-flex align-items-center">
                                            <div class="numbers">
                                                ...
                                                <h4 class="card-title font-weight-bold">$ 1,345</h4>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="card card-stats card-danger">
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-7 d-flex align-items-center">
                                            <div class="numbers">
                                                <p class="card-category">STK Kadaluarsa</p>
                                                <h4 class="card-title font-weight-bold">1303</h4>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-7 d-flex align-items-center">
                                            <div class="numbers">
                                                ...
                                                <h4 class="card-title font-weight-bold">76</h4>
                                            </div>
                                        </div>
                                    </div>
                                </div>
