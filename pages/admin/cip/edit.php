...
<head>
    ...
    <title>Edit Data CIP | E-Arsip - QM Pertamina RU III</title>
                ...
                <ul class="nav">
                    ...
                    <li class="nav-item collapse">
                        ...
                        <div class="collapse in" id="collapseDokumen" aria-expanded="true">
                            ...
                            <a href="../surat-kebijakan/data_surat-kebijakan.php">
                                &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                                <span class="la la-caret-right"></span>
                                &nbsp;
                                <span>Kebijakan</span>
                ...
                <div class="container-fluid">
                    <div class="row page-title">
                        <div class="col-md-6 col-8 align-self-center">
                            <h4 class="page-title font-weight-bold">Edit Data CIP</h4>
                        </div>
                    </div>
                    &nbsp;
                    <div class="row">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <form action="" method="POST">
                                        <input type="hidden" value="<?php echo $data['id_cip']; ?>" name="id_cip">
                                        ...
                                        <div class="form-group form-inline">
                                            ...
                                            <div class="col-md-10 p-0">
                                                <input type="text" class="form-control input-full" id="no_pendaftaran" name="no_pendaftaran" required>
                                            </div>
                                        </div>
                                        <div class="form-group form-inline">
                                            <label for="nama_gugus" class="col-md-2 col-form-label">Nama Gugus</label>
                                            <div class="col-md-10 p-0">
                                                <input type="text" class="form-control input-full" id="nama_gugus" name="nama_gugus" required>
                                            </div>
                                        </div>
                                        <div class="form-group form-inline">
                                            <label for="jenis_gugus" class="col-md-2 col-form-label">Jenis Gugus</label>
                                            <div class="col-md-10 p-0">
                                                <select class="form-control" name="jenis_gugus" id="jenis_gugus" required>
                                                    <option value="I - Prove">I - Prove</option>
                                                    <option value="PC - Prove">PC - Prove</option>
                                                    <option value="FT - Prove">FT - Prove</option>
                                                    <option value="RT - Prove">RT - Prove</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="form-group form-inline">
                                        ...
                                        <div class="form-group form-inline">
                                            <label for="file_pdf" class="col-md-2 col-form-label">Upload file ZIP</label>
                                            <div class="col-md-10 p-0">
