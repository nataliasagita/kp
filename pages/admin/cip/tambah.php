...
<head>
    ...
    <title>Tambah Data CIP | E-Arsip - QM Pertamina RU III</title>
                ...
                <div class="container-fluid">
                    <div class="row page-title">
                        <div class="col-md-6 col-8 align-self-center">
                            <h4 class="page-title font-weight-bold">Tambah Data CIP</h4>
                        </div>
                    </div>
                    &nbsp;
                    <div class="row">
                                ...
                                <div class="card-body">
                                    <form action="" method="POST">
                                        ...
                                        <div class="form-group form-inline">
                                            ...
                                            <div class="col-md-10 p-0">
                                                <select class="form-control" name="jenis_gugus" id="jenis_gugus">
