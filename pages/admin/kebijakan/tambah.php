...
<head>
    ...
    <title>Tambah Kebijakan | E-Arsip - QM Pertamina RU III</title>
                ...
                <div class="container-fluid">
                    <div class="row page-title">
                        <div class="col-md-6 col-8 align-self-center">
                            <h4 class="page-title font-weight-bold">Tambah Kebijakan</h4>
                        </div>
                    </div>
                    &nbsp;
                    <div class="row">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <form action="proses_tambah.php" method="POST" enctype="multipart/form-data">
                                        <input type="hidden" value="<?php echo $data['id_kebijakan']; ?>" name="id_kebijakan">
                                        ...
                                        <div class="form-group form-inline">
                                            <label for="nama_pejabat" class="col-md-2 col-form-label">Nama Pejabat</label>
                                            <div class="col-md-10 p-0">
                                                <input type="text" class="form-control input-full" id="nama_pejabat" name="nama_pejabat" required>
                                            </div>
                                        </div>
                                        <div class="form-group form-inline">
                                            <label for="file_pdf" class="col-md-2 col-form-label">Upload file PDF</label>
                                            <div class="col-md-5 p-0">
                                                <input type="file" class="form-control-file" id="" name="file_pdf" accept="application/pdf, .pdf" required>
                                            </div>
                                        </div>
                                        <div class="form-group row float-right">
                                            <div class="col-sm-5 mb-2 mr-2">
                                                <a href="data_kebijakan.php" class="btn btn-danger p-2 float-right">Batal</a>
                                            </div>
