...
<head>
    ...
    <title>Data Kebijakan | E-Arsip - QM Pertamina RU III</title>
                ...
                <ul class="nav">
                    ...
                    <li class="nav-item collapse">
                        ...
                        <div class="collapse in" id="collapseDokumen" aria-expanded="true">
                            ...
                            <a href="data_kebijakan.php" class="active bg-active">
                                &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                                <span class="la la-caret-right"></span>
                                &nbsp;
                                <span>Kebijakan</span>
                ...
                <div class="container-fluid">
                    <div class="row page-title">
                        <div class="col-md-6 col-8 align-self-center">
                            <h4 class="page-title font-weight-bold">Data Kebijakan</h4>
                        </div>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-striped table-bordered table-hover" id="tabelDokumen">
                                            ...
                                            <tbody>
                                                <?php
                                                $no = 1;
                                                $hasil = mysqli_query($koneksi, "SELECT*FROM tb_kebijakan");
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="download_pdf.php?id_kebijakan=<?= $data["id_kebijakan"]; ?>" target="_blank">
                                                                <i class="la la-file-pdf-o"></i>&nbsp;<?= $data['file_pdf']; ?>
                                                            </a>
                                                        </td>
                                                        <td>
                                                            <a href="edit.php?id_kebijakan=<?= $data["id_kebijakan"]; ?>" class="btn btn-warning p-1 mr-1 mb-1">
                                                                <i class="la la-edit"></i>
                                                            </a>
                                                            <a href="delete.php?id_kebijakan=<?= $data["id_kebijakan"]; ?>" class="btn btn-danger p-1 mr-1 mb-1 delete">
